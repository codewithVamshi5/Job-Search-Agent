...
My Profile (configured in this repo)

Name: Ketireddypally Vamshi
Degree: B.Tech CSE (AI & ML), Vardhaman College of Engineering, Hyderabad — 2023-2027
CGPA: 9.1
Target: ML / AI / Software Engineering internships in Hyderabad
Key projects: RepoGuardian (multi-agent code review), NLP Text Processing (Infosys Springboard)
Hackathons: Avishkar National — Top 1% (200+ teams), AgentForge — Runner-Up (Salesforce 2026)
